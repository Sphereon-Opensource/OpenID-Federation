...
//        mockkConstructor(KmsService::class)
////        mockkConstructor(JwkService::class)
//
...
//
//        every {
//            anyConstructed<KmsService>().getKmsProvider()
//        } returns EcDSACryptoProvider()
//
////        coEvery {
////            anyConstructed<JwkService>().getKeys(any())
////        } returns arrayOf(
////            AccountJwk(
////                kid = "test-kid",
////                kty = "EC",
...
//
//
//        resolutionService = ResolutionService(accountService, jwkService, kmsService)
//    }
//
//    @AfterTest
//    fun cleanup() {
...
//            TRUST_MARK_ID to listOf("https://issuer.example.org")
//        )
//
...
//            iat = 1609459200,
//            exp = 1609545600,
//            authorityHints = listOf(TRUST_ANCHOR),
//            metadata = metadata,
