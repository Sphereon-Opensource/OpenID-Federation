package com.sphereon.openid.fed.client.config
...
/**
 * AppConfig-backed [OidfConfigBinder] for any composition root that hosts the federation client.
 *
 * This class is not a Metro contribution. Federation servers bind it via
 * [com.sphereon.openid.fed.services.config.OidfConfigBinderImpl]. Wallet and other client
 * composition roots provide it explicitly so they do not pull the federation server module.
 */
open class AppConfigOidfConfigBinder(
    ...
    protected fun getPropertyOrNull(key: String): String? {
        val value = getProperty(key, "")
