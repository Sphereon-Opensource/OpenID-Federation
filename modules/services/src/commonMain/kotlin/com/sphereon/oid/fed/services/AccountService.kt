...
class AccountService(
    ...
    fun createAccount(account: CreateAccount): AccountEntity {
    ...
    fun getAccountIdentifierByAccount(account: AccountEntity): String {
    ...
    fun deleteAccount(account: Account): AccountEntity {
