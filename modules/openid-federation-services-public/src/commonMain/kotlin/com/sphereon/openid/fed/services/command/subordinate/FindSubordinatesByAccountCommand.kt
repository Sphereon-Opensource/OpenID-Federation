...
data class FindSubordinatesByAccountArgs(val tenantId: String)

interface FindSubordinatesByAccountCommand : ServiceCommand<FindSubordinatesByAccountArgs, Array<Subordinate>, FederationError>, PublicApiCommand {
    companion object {
