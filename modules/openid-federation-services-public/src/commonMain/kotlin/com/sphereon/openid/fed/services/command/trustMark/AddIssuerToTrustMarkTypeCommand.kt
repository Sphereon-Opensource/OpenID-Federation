...
data class AddIssuerToTrustMarkTypeArgs(val tenantId: String, val trustMarkTypeId: String, val issuerIdentifier: String)

interface AddIssuerToTrustMarkTypeCommand : ServiceCommand<AddIssuerToTrustMarkTypeArgs, TrustMarkIssuer, FederationError>, PublicApiCommand {
    companion object {
